...
class SwaggerExplorer {
    ...
    generateDenormalizedDocument(metatype, prototype, instance, documentResolvers, applicationConfig, modulePath, globalPrefix) {
        ...
        const denormalizedPaths = this.metadataScanner.scanFromPrototype(instance, prototype, (name) => {
            ...
            if (Array.isArray(methodMetadata.root)) {
                return methodMetadata.root.map((endpointMetadata) => {
                    endpointMetadata = (0, lodash_1.cloneDeep)({
                        ...methodMetadata,
                    ...
                    return this.migrateOperationSchema({
                        responses: {},
                        ...(0, lodash_1.omit)(globalMetadata, 'chunks'),
                        ...mergedMethodMetadata
                    }, prototype, targetCallback);
                });
            }
        ...
        return (0, lodash_1.flatten)(denormalizedPaths).filter((path) => path.root?.path);
    }
    ...
    migrateOperationSchema(document, prototype, method) {
        ...
        document.root.requestBody = {
            ...(0, lodash_1.omit)(requestBody, keysToRemove),
            ...this.mimetypeContentWrapper.wrap(consumes, (0, lodash_1.pick)(requestBody, ['schema', 'examples']))
        };
        return document;
    }
