...
function ApiOperation(options, { overrideExisting } = { overrideExisting: true }) {
    return (0, helpers_1.createMethodDecorator)(constants_1.DECORATORS.API_OPERATION, (0, lodash_1.pickBy)({
        ...defaultOperationOptions,
        ...options
    }, (0, lodash_1.negate)(lodash_1.isUndefined)), { overrideExisting });
}
