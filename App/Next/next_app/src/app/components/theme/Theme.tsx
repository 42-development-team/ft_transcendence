...
export const Theme = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ...
    localStorage.getItem("theme") === "mocha" || null ? setPosition("left") : setPosition("right");
  }, []);
          ...
          <div className="inline-flex items-center">
            <div className="relative inline-block h-4 w-8 cursor-pointer rounded-full">
              ...
              <label
                ...
                className={`before:content[''] absolute top-2/4 -${position}-1 h-5 w-5 -translate-y-2/4 cursor-pointer rounded-full border border-blue-gray-100 bg-white shadow-md transition-all duration-300 before:absolute before:top-2/4 before:left-2/4 before:block before:h-10 before:w-10 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity hover:before:opacity-10 peer-checked:translate-x-full peer-checked:border-pink-500 peer-checked:before:bg-pink-500`}
              >
                <div
