...
const JoinChannelButton = () => {
    ...
    return (
        <li className={style.channelItem}>
            <Tooltip placement="right" content={"Join channel"} className="tooltip text-text" offset={8}>
                <button onClick={() => updateChatBarState(ChatBarState.JoinChannelOpen)} className='rounded-[inherit] w-[inherit] h-[inherit]'>
