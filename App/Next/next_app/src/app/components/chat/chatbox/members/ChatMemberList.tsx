        ...
        <div className='flex flex-row justify-between '>
            <button onClick={() => updateChatBarState(ChatBarState.ChatMembersOpen)} >
                <svg viewBox="0 0 24 24" aria-hidden="false" width={"28"} height={"28"} className={`${style.channelIcon}`}>
                    ...
                    <path d="M8 11H8.009M11.991 11H12M15.991 11H16" fill="currentColor" stroke="currentColor" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"></path>
                </svg> 
            </button>
